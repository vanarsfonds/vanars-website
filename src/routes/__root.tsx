...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pastoor Van Ars Stichting" },
      {
        name: "description",
        content:
          "Heilige Pastoor Van Ars Stichting — ondersteuning van traditioneel katholieke roepingen en Nederlandse seminaristen bij het Instituut Christus Koning.",
      },
